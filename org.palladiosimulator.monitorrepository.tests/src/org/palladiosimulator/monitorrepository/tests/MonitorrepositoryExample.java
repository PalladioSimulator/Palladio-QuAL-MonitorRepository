...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>monitorrepository</b></em>' package.
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class MonitorrepositoryExample {
    /**
    ...
    public static void main(final String[] args) {
        ...
        .put(Resource.Factory.Registry.DEFAULT_EXTENSION, new MonitorrepositoryResourceFactoryImpl());

        // Register the package to ensure it is available during loading.
        //
        resourceSet.getPackageRegistry().put(MonitorrepositoryPackage.eNS_URI, MonitorrepositoryPackage.eINSTANCE);
        ...
        if (args.length == 0) {
            ...
            try {
                final Resource resource = resourceSet.createResource(URI.createURI("http:///My.monitorrepository"));
                final MonitorRepository root = MonitorrepositoryFactory.eINSTANCE.createMonitorRepository();
