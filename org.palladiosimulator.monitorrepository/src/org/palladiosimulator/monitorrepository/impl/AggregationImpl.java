 ...
 * <ul>
 * <li>
 * {@link org.palladiosimulator.monitorrepository.impl.AggregationImpl#getStatisticalCharacterization
 * <em>Statistical Characterization</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AggregationImpl extends SpecificationKindImpl implements Aggregation {
    /**
    ...
    protected EClass eStaticClass() {
        return MonitorRepositoryPackage.Literals.AGGREGATION;
    }
    ...
    public StatisticalCharacterization getStatisticalCharacterization() {
        return (StatisticalCharacterization) this.eDynamicGet(
                MonitorRepositoryPackage.AGGREGATION__STATISTICAL_CHARACTERIZATION,
    ...
    public NotificationChain basicSetStatisticalCharacterization(
        ...
        msgs = this.eDynamicInverseAdd((InternalEObject) newStatisticalCharacterization,
                MonitorRepositoryPackage.AGGREGATION__STATISTICAL_CHARACTERIZATION, msgs);
        return msgs;
    }
    ...
    public void setStatisticalCharacterization(final StatisticalCharacterization newStatisticalCharacterization) {
        this.eDynamicSet(MonitorRepositoryPackage.AGGREGATION__STATISTICAL_CHARACTERIZATION,
