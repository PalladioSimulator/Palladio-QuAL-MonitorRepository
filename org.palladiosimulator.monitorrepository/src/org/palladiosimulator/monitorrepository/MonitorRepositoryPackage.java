...
public interface MonitorRepositoryPackage extends EPackage {
     ...
     * @ordered
     */
    int TIME_DRIVEN__WINDOW_CHARACTERIZATION = PROCESSING_TYPE_FEATURE_COUNT + 0;
     ...
     * @ordered
     */
    int TIME_DRIVEN_FEATURE_COUNT = PROCESSING_TYPE_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int TIME_DRIVEN_AGGREGATION__WINDOW_CHARACTERIZATION = TIME_DRIVEN__WINDOW_CHARACTERIZATION;
     ...
     * @see org.palladiosimulator.monitorrepository.VariableSizeAggregation#getRetrospection()
     * @see #getVariableSizeAggregation()
     * @generated
     */
    EReference getVariableSizeAggregation_Retrospection();
    ...
    interface Literals {
        ...
        /**
         * The meta object literal for the '<em><b>Retrospection</b></em>' containment reference
         * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
         *
         * @generated
         */
        EReference VARIABLE_SIZE_AGGREGATION__RETROSPECTION = eINSTANCE.getVariableSizeAggregation_Retrospection();
