...
public class MeasurementSpecificationItemProvider extends IdentifierItemProvider {
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(MonitorRepositoryPackage.Literals.MEASUREMENT_SPECIFICATION__SPECIFICATION_KIND);
        }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors.add(this.createChildParameter(
                MonitorRepositoryPackage.Literals.MEASUREMENT_SPECIFICATION__SPECIFICATION_KIND,
        ...
        newChildDescriptors.add(this.createChildParameter(
                MonitorRepositoryPackage.Literals.MEASUREMENT_SPECIFICATION__SPECIFICATION_KIND,
                MonitorRepositoryFactory.eINSTANCE.createTimeDrivenVariableSizeAggregation()));

        newChildDescriptors.add(this.createChildParameter(
                MonitorRepositoryPackage.Literals.MEASUREMENT_SPECIFICATION__SPECIFICATION_KIND,
                MonitorRepositoryFactory.eINSTANCE.createMeasurementDrivenVariableSizeAggregation()));

        newChildDescriptors.add(this.createChildParameter(
                MonitorRepositoryPackage.Literals.MEASUREMENT_SPECIFICATION__SPECIFICATION_KIND,
                MonitorRepositoryFactory.eINSTANCE.createSingleValue()));
    }
