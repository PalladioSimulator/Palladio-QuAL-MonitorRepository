 ...
 * @generated
 */
public class TimeDrivenItemProvider extends SpecificationKindItemProvider {
    /**
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(final Object object) {
        if (this.childrenFeatures == null) {
            ...
            this.childrenFeatures.add(MonitorRepositoryPackage.Literals.TIME_DRIVEN__WINDOW_CHARACTERIZATION);
        }
    ...
    protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
        ...
        newChildDescriptors
                .add(this.createChildParameter(MonitorRepositoryPackage.Literals.TIME_DRIVEN__WINDOW_CHARACTERIZATION,
                        MonitorRepositoryFactory.eINSTANCE.createWindowCharacterization()));
    }
